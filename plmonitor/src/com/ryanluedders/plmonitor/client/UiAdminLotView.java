 ...
 *=====================================================================*/
public class UiAdminLotView extends ServerAccessor
{	
	...
	public DialogGetName dlgGName = new DialogGetName(false,false,"Enter new name:");
	//A dialog box used to get the name of a new spot
	public DialogGetName dlgGNameSpot = new DialogGetName(false,false,"Enter new name:");
	//A dialog box used to get the filename for the img
	public DialogGetName dlgImg = new DialogGetName(false,false,"Enter image name:");
	
	//a spot detailed info box
	public PanelEditSpot editSpot = new PanelEditSpot("");
