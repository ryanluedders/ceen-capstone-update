...
function ts(p){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,q;a=p.hb;while(Ef(a)>0){rg(a,Ff(a,0));}l=1;d=1;for(h=kH(p.jb);aH(h);){c=bH(h);e=c.pb.a;if(e===Cs||e===Ds){++l;}else if(e===Bs||e===Es){++d;}}m=ee('[Lcom.google.gwt.user.client.ui.DockPanel$TmpRow;',[238],[11],[l],null);for(g=0;g<l;++g){m[g]=new ns();m[g].b=jf();De(a,m[g].b);}q=0;f=d-1;j=0;n=l-1;b=null;for(h=kH(p.jb);aH(h);){c=bH(h);i=c.pb;o=hf();i.d=o;zg(i.d,'align',i.b);Fg(i.d,'verticalAlign',i.e);zg(i.d,'width',i.f);zg(i.d,'height',i.c);if(i.a===Cs){mg(m[j].b,o,m[j].a);De(o,c.rb);yg(o,'colSpan',f-q+1);++j;}else if(i.a===Ds){mg(m[n].b,o,m[n].a);De(o,c.rb);yg(o,'colSpan',f-q+1);--n;}else if(i.a===Es){k=m[j];mg(k.b,o,k.a++);De(o,c.rb);yg(o,'rowSpan',n-j+1);++q;}else if(i.a===Bs){k=m[j];mg(k.b,o,k.a);De(o,c.rb);yg(o,'rowSpan',n-j+1);--f;}else if(i.a===As){b=o;}}if(p.eb!==null){k=m[j];mg(k.b,b,k.a);De(b,p.eb.rb);}}
...
function CL(a){if(a.eQ(this.a.b.b)){eM(this.a,kF(this.a.b.j),kF(this.a.b.i));nM(this.a.b);}if(a.eQ(this.a.b.a)){e4(this.a.i,true);uG(this.a.d,this.a.i);nM(this.a.b);}if(a.eQ(this.a.i.c)){xG(this.a.d,this.a.i);p3(this.a.g);e4(this.a.i,false);q3(this.a.g,true);uG(this.a.d,this.a.g);}if(a.eQ(this.a.g.a)){xG(this.a.d,this.a.g);c4(this.a.i);q3(this.a.g,false);e4(this.a.i,true);uG(this.a.d,this.a.i);this.a.g.g.ne(false);this.a.g.h.ne(false);}if(a.eQ(this.a.g.c)){xG(this.a.d,this.a.g);g5(this.a.j,uz(this.a.g.l,vz(this.a.g.l)));q3(this.a.g,false);h5(this.a.j,true);uG(this.a.d,this.a.j);this.a.g.g.ne(false);this.a.g.h.ne(false);}if(a.eQ(this.a.j.a)){xG(this.a.d,this.a.j);p3(this.a.g);h5(this.a.j,false);q3(this.a.g,true);uG(this.a.d,this.a.g);}if(a.eQ(this.a.j.c)){xG(this.a.d,this.a.j);i2(this.a.f);h5(this.a.j,false);if(this.a.c){j2(this.a.f,true);uG(this.a.d,this.a.f);}else{wB(this.a.b);this.a.b.re();}}if(a.eQ(this.a.i.b)){xG(this.a.d,this.a.i);i2(this.a.f);e4(this.a.i,false);if(this.a.c){j2(this.a.f,true);uG(this.a.d,this.a.f);}else{wB(this.a.b);this.a.b.re();}}if(a.eQ(this.a.f.c)){xG(this.a.d,this.a.f);c4(this.a.i);j2(this.a.f,false);e4(this.a.i,true);this.a.c=false;uG(this.a.d,this.a.i);}if(a.eQ(this.a.h.c)){xG(this.a.d,this.a.h);i2(this.a.f);n0(this.a.h,false);j2(this.a.f,true);uG(this.a.d,this.a.f);this.a.h.r.ne(false);}if(a.eQ(this.a.h.f)){xG(this.a.d,this.a.h);c4(this.a.i);n0(this.a.h,false);e4(this.a.i,true);this.a.c=false;uG(this.a.d,this.a.i);this.a.h.r.ne(false);}if(a.eQ(this.a.g.b)){xG(this.a.d,this.a.g);i2(this.a.f);if(this.a.c){j2(this.a.f,true);uG(this.a.d,this.a.f);}else{wB(this.a.b);this.a.b.re();}this.a.g.g.ne(false);this.a.g.h.ne(false);}if(a.eQ(this.a.f.b)){m0(this.a.h,uz(this.a.f.i,vz(this.a.f.i)));l0(this.a.h);xG(this.a.d,this.a.f);j2(this.a.f,false);n0(this.a.h,true);uG(this.a.d,this.a.h);this.a.g.g.ne(false);this.a.g.h.ne(false);}}
function zL(){}
...
function eV(b){tU();var a;a=b.wd();return ee('[I',[236],[(-1)],[a],0);}
...
function b5(v,r,a,c,b,n,p,s,u,k,m){var d,e,f,g,h,i,j,l,o,q,t,w;o=0;t=0;l=0;e=0;d=0;o=pe((n+p)/2);t=pe((s+u)/2);l=pe((k+m)/2);e=pe((o+t)/2);d=pe((t+l)/2);h=e;i=c;f=d;g=b;j=g-i;w=f-h;if(m5){d_(),g_;d_(),g_;d_(),g_;d_(),g_;d_(),g_;}if(a==1)bjb(v.h,(Ehb(),cib));else if(a==0)bjb(v.h,(Ehb(),dib));else bjb(v.h,(Ehb(),bib));q=ee('[I',[236],[(-1)],[5],0);q[0]=a;q[1]=wF(v.l)+h;q[2]=xF(v.l)+i;q[3]=w;q[4]=j;return q;}
