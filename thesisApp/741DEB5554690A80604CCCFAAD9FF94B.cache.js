...
function cu(p){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,q;a=p.jb;while(bh(a)>0){uh(a,ch(a,0));}l=1;d=1;for(h=AI(p.lb);qI(h);){c=rI(h);e=c.rb.a;if(e===lu||e===mu){++l;}else if(e===ku||e===nu){++d;}}m=ee('[Lcom.google.gwt.user.client.ui.DockPanel$TmpRow;',[247],[12],[l],null);for(g=0;g<l;++g){m[g]=new Ct();m[g].b=mg();bg(a,m[g].b);}q=0;f=d-1;j=0;n=l-1;b=null;for(h=AI(p.lb);qI(h);){c=rI(h);i=c.rb;o=lg();i.d=o;Ch(i.d,'align',i.b);ci(i.d,'verticalAlign',i.e);Ch(i.d,'width',i.f);Ch(i.d,'height',i.c);if(i.a===lu){ph(m[j].b,o,m[j].a);bg(o,c.tb);Bh(o,'colSpan',f-q+1);++j;}else if(i.a===mu){ph(m[n].b,o,m[n].a);bg(o,c.tb);Bh(o,'colSpan',f-q+1);--n;}else if(i.a===nu){k=m[j];ph(k.b,o,k.a++);bg(o,c.tb);Bh(o,'rowSpan',n-j+1);++q;}else if(i.a===ku){k=m[j];ph(k.b,o,k.a);bg(o,c.tb);Bh(o,'rowSpan',n-j+1);--f;}else if(i.a===ju){b=o;}}if(p.gb!==null){k=m[j];ph(k.b,b,k.a);bg(b,p.gb.tb);}}
...
function CN(a){dI(a);BN(a);a.i.c.ub(a.a);a.g.a.ub(a.a);a.g.c.ub(a.a);a.j.a.ub(a.a);a.j.c.ub(a.a);a.f.c.ub(a.a);a.i.b.ub(a.a);a.h.c.ub(a.a);a.h.f.ub(a.a);a.g.b.ub(a.a);a.f.b.ub(a.a);a.b.a.ub(a.a);a.b.b.ub(a.a);a.ne('90%');a.se('100%');eI(a.d,a.i);eI(a,a.d);a.d.ne('100%');a.d.se('100%');aO(a,300000);FN(a,15000);fj(a.e,10000);return a;}
